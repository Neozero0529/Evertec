package com.evertec.store.config;
...
import com.evertec.store.filter.Slf4jMDCFilter;

@Configuration
@ConfigurationProperties(prefix = "config.slf4jfilter")
public class Slf4jMDCFilterConfiguration {
	public static final String DEFAULT_RESPONSE_TOKEN_HEADER = "Response-requestId";
